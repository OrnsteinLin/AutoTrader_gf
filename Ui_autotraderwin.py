...
class Ui_AutoTraderWin(object):
    def setupUi(self, AutoTraderWin):
        ...
        self.pushButton_start.setGeometry(QtCore.QRect(20, 300, 75, 23))
        self.pushButton_start.setObjectName("pushButton_start")
        self.pushButton_stop = QtWidgets.QPushButton(AutoTraderWin)
        self.pushButton_stop.setGeometry(QtCore.QRect(110, 300, 75, 23))
        self.pushButton_stop.setObjectName("pushButton_stop")
        self.pushButton_test = QtWidgets.QPushButton(AutoTraderWin)
        self.pushButton_test.setGeometry(QtCore.QRect(200, 300, 75, 23))
